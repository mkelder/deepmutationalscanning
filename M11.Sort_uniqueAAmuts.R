...
for (filename in c("GFP_Nicks_VarSil_Int_AllPooled.HRunique.HR.mutations","GFP_Nicks_VarSil_Neg_AllPooled.HRunique.HR.mutations",
                   "GFP_Nicks_VarSil_Pos_AllPooled.HRunique.HR.mutations","GFP_Nicks_VarStop_Neg_AllPooled.HRunique.HR.mutations"
)){
...
for (filename in c("GFP_Nicks_VarSil_Int.mutfreq.all.CSV",
                    "GFP_Nicks_VarSil_Neg.mutfreq.all.CSV",
                    "GFP_Nicks_VarSil_Pos.mutfreq.all.CSV",
                    "GFP_Nicks_VarStop_Neg.mutfreq.all.CSV"
)){
  mutationfile<-read.csv(filename, stringsAsFactors = FALSE)
  assign(filename,mutationfile)
}
mergedfile <- as.data.frame(rbind(GFP_Nicks_VarSil_Int.mutfreq.all.CSV,
                                  GFP_Nicks_VarSil_Neg.mutfreq.all.CSV,
                                  GFP_Nicks_VarSil_Pos.mutfreq.all.CSV,
                                  GFP_Nicks_VarStop_Neg.mutfreq.all.CSV))
write.csv(mergedfile, "GFP_Jan2018_merged.mutfreq.all.CSV")

for (filename in c("GFP_Nicks_VarSil_Int.mutfreq.var.CSV",
                   "GFP_Nicks_VarSil_Neg.mutfreq.var.CSV",
                   "GFP_Nicks_VarSil_Pos.mutfreq.var.CSV",
                   "GFP_Nicks_VarStop_Neg.mutfreq.var.CSV",
                   "GFP_Oligo.mutfreq.var.CSV"
)){
  mutationfile<-read.csv(filename, stringsAsFactors = FALSE)
  assign(filename,mutationfile)
}
mergedfile <- as.data.frame(rbind(GFP_Nicks_VarSil_Int.mutfreq.var.CSV,
                                  GFP_Nicks_VarSil_Neg.mutfreq.var.CSV,
                                  GFP_Nicks_VarSil_Pos.mutfreq.var.CSV,
                                  GFP_Nicks_VarStop_Neg.mutfreq.var.CSV,
                                  GFP_Oligo.mutfreq.var.CSV))
write.csv(mergedfile, "GFP_Jan2018_merged.mutfreq.var.CSV")